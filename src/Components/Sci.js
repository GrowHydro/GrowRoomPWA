...
const Sci=()=>{
    ...
    return(<>
            ...
            <h1>Welcome to the Future of Growing</h1>
                <p className="weed"><img src={Scix} alt="weed" /></p>
                ...
                <p>So if you're looking for a way to revolutionize your gardening game, hydroponics is the way to go.</p>
            </div>
           </>)
}
